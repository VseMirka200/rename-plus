...
Содержит функции для работы с файлами: добавление в список,
валидация имен, проверка конфликтов и переименование.
Оптимизирован для работы с большими списками файлов.
"""
